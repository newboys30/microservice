package com.bioFish.DAOService.DaoSupport;
...
* @author lee 
* @date 2016年3月30日 下午2:19:06 
*
 */
@Repository("daoSupport")
public class DaoSupport implements BaseDaoI {
	...
	public Integer findForID(String str) throws Exception {
